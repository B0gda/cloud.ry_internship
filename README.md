...
1. Расскажите, с какими задачами в направлении безопасной разработки вы сталкивались?
    ##### Ответ:
    На пути к освоению безопасной разработки я сталкивался с различными задачами и вызовами. Мой первый опыт в этой области был приобретен во время участия в соревнованиях Tinkoff CTF. Там мне приходилось искать уязвимости, связанные с неправильным роутингом, такими как SQL-инъекции, ошибками в логике приложения. Этот опыт позволил мне глубже понять принципы безопасности в разработке и развить навыки по обнаружению и устранению потенциальных угроз.
